...
nix run nixpkgs#prioricode           # lub github:anomalyco/prioricode dla najnowszej gałęzi dev
```
...
PrioriCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/prioricode/releases) lub z [prioricode.ai/download](https://prioricode.ai/download).
...
Dowiedz się więcej o [agents](https://prioricode.ai/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji PrioriCode znajdziesz w [**dokumentacji**](https://prioricode.ai/docs).
...
**Dołącz do naszej społeczności** [Discord](https://discord.gg/prioricode) | [X.com](https://x.com/prioricode)
