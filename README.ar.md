...
nix run nixpkgs#prioricode           # او github:anomalyco/prioricode لاحدث فرع dev
```
...
يتوفر PrioriCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/prioricode/releases) او من [prioricode.ai/download](https://prioricode.ai/download).
