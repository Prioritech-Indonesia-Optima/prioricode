...
- PR #13942: https://github.com/Prioritech-Indonesia-Optima/prioricode/pull/13942

## Do Not Translate (Locale Additions)

- `PrioriCode` (preserve casing in prose; keep `prioricode` only when it is part of commands, package names, paths, or code)
- `PrioriCode Zen`
- `PrioriCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `prioricode` in prose when referring to the product name; use `PrioriCode`
