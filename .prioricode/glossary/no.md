...
- PR #10018: https://github.com/Prioritech-Indonesia-Optima/prioricode/pull/10018
- PR #12935: https://github.com/Prioritech-Indonesia-Optima/prioricode/pull/12935

## Do Not Translate (Locale Additions)

- `PrioriCode` (preserve casing in prose; keep `prioricode` only in commands, package names, paths, or code)
- `PrioriCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
