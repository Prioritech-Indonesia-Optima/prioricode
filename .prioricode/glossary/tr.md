...
- PR #15835: https://github.com/Prioritech-Indonesia-Optima/prioricode/pull/15835

## Do Not Translate (Locale Additions)

- `PrioriCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `prioricode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `PrioriCode` in prose, `prioricode` only for exact technical identifiers
...
- Avoid changing `prioricode` to `PrioriCode` inside commands, URLs, package names, or code literals
