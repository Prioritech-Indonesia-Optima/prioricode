...
nix run nixpkgs#prioricode           # 또는 github:anomalyco/prioricode 로 최신 dev 브랜치
```
...
PrioriCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/prioricode/releases) 에서 직접 다운로드하거나 [prioricode.ai/download](https://prioricode.ai/download) 를 이용하세요.
