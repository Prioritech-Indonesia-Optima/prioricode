...
nix run nixpkgs#prioricode           # または github:anomalyco/prioricode で最新 dev ブランチ
```
...
PrioriCode はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/prioricode/releases) から直接ダウンロードするか、[prioricode.ai/download](https://prioricode.ai/download) を利用してください。
