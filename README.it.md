...
nix run nixpkgs#prioricode           # oppure github:anomalyco/prioricode per l’ultima branch di sviluppo
```
...
PrioriCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/prioricode/releases) oppure da [prioricode.ai/download](https://prioricode.ai/download).
