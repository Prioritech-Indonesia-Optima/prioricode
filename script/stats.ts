...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Prioritech-Indonesia-Optima/prioricode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Prioritech-Indonesia-Optima/prioricode...\n")
...
console.log("Fetching npm all-time downloads for prioricode-ai...\n")
const npmDownloads = await fetchNpmDownloads("prioricode-ai")
