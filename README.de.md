...
nix run nixpkgs#prioricode           # oder github:anomalyco/prioricode für den neuesten dev-Branch
```
...
PrioriCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/anomalyco/prioricode/releases) oder [prioricode.ai/download](https://prioricode.ai/download) herunter.
...
Mehr dazu unter [Agents](https://prioricode.ai/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von PrioriCode findest du in unseren [**Docs**](https://prioricode.ai/docs).
...
**Tritt unserer Community bei** [Discord](https://discord.gg/prioricode) | [X.com](https://x.com/prioricode)
