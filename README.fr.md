...
nix run nixpkgs#prioricode           # ou github:anomalyco/prioricode pour la branche dev la plus récente
```
...
PrioriCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/prioricode/releases) ou [prioricode.ai/download](https://prioricode.ai/download).
...
En savoir plus sur les [agents](https://prioricode.ai/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'PrioriCode, [**consultez notre documentation**](https://prioricode.ai/docs).
...
**Rejoignez notre communauté** [Discord](https://discord.gg/prioricode) | [X.com](https://x.com/prioricode)
