# PrioriCode V2 Promise Plugin API

The Promise plugin API is the async/await equivalent of `@prioricode/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
