...
- Effect plugins import `@prioricode/plugin/v2/effect`, not `@prioricode/core`.
- Public domain values use generated `@prioricode/sdk` types.
...
- Define `PluginHost` domain capabilities in `@prioricode/plugin/v2/effect`.
