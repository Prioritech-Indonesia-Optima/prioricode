...
import type { Provider as ProviderV2, Model as ModelV2, Auth } from "@prioricode/sdk/v2"
...
export type PluginInput = {
  client: ReturnType<typeof createPrioricodeClient>
  project: Project
  directory: string
  worktree: string
