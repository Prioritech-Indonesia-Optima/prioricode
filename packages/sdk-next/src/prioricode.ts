import { PrioriCode } from "@prioricode/client/effect"
...
import { createEmbeddedRoutes } from "@prioricode/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("PrioriCode.create")(function* () {
  ...
  const client = yield* PrioriCode.make({ baseUrl: "http://prioricode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/sdk-next/PrioriCode") {}
