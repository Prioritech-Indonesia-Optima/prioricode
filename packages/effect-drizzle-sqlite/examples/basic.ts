...
class Database extends Context.Service<Database, DatabaseShape>()("@prioricode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@prioricode/example/UserStore") {
