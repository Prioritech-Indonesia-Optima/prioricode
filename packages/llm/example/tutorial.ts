...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@prioricode/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@prioricode/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-prioricode-tutorial": "1" },
    query: { debug: "1" },
  },
})
