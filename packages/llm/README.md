...
Schema-first LLM core for prioricode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@prioricode/llm"
import { OpenAI } from "@prioricode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@prioricode/llm/providers"
