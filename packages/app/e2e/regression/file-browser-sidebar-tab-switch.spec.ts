...
const directory = "C:/PrioriCode/FileBrowserSidebar"
...
async function setup(
  ...
  await mockPrioriCodeServer(page, {
    ...
    provider: {
      ...
      default: { providerID: "prioricode", modelID: "test" },
    },
    sessions: [
      {
        id: sessionID,
  ...
  await page.addInitScript(
    ({ directory, server, sessionID }) => {
      ...
      localStorage.setItem(
        "prioricode.global.dat:layout",
        JSON.stringify({ review: { diffStyle: "split", panelOpened: true } }),
      )
      localStorage.setItem(
        "prioricode.global.dat:review-panel-v2",
