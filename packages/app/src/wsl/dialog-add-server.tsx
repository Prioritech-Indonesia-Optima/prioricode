...
import { showToast } from "@prioricode/ui/toast"
...
import { RadioGroupV2, RadioItemV2 } from "@prioricode/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-prioricode") {
      await run(() => api.installPrioricode(distro))
      return
    }
