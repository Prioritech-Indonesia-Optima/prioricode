export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "PrioriCode مینو",
  ...
  "desktop.recovery.loadFailed": "PrioriCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "PrioriCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "PrioriCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.prioricodeMissing": "اس ڈسٹری بیوشن میں prioricode انسٹال نہیں ہے",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.prioricodeNotInstalled": "{{distro}} میں PrioriCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "PrioriCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.prioricode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.prioricode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.prioricodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور PrioriCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور PrioriCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور PrioriCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "prioricode.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس PrioriCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}} میں PrioriCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}} میں PrioriCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatePrioricodeIn": "{{distro}} میں PrioriCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updatePrioricode": "PrioriCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.prioricodeReady": "PrioriCode تیار ہے۔",
  "wsl.onboarding.installPrioricodeIn": "{{distro}} میں PrioriCode انسٹال کریں۔",
  "wsl.onboarding.installPrioricode": "PrioriCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ PrioriCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر PrioriCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "PrioriCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم PrioriCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (prioricode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، PrioriCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "PrioriCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر PrioriCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "PrioriCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر PrioriCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا PrioriCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "PrioriCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "PrioriCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ PrioriCode کا تازہ ترین ورژن چلا رہے ہیں۔",
