export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل PrioriCode",
  "desktop.recovery.terminated": "توقفت نافذة PrioriCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "PrioriCode لا يستجيب",
  ...
  "desktop.wsl.error.installPrioricode": "فشل تثبيت PrioriCode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.prioricodeMissing": "prioricode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث PrioriCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.prioricode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.prioricode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.prioricodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "يمنحك PrioriCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في PrioriCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في prioricode.json",
  ...
  "dialog.server.description": "تبديل خادم PrioriCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingPrioricode": "جارٍ التحقق من PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "جارٍ التحقق من PrioriCode في {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "جارٍ تحديث PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "جارٍ تحديث PrioriCode في {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "حدّث PrioriCode في {{distro}}.",
  "wsl.onboarding.updatePrioricode": "تحديث PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode جاهز في {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode جاهز.",
  "wsl.onboarding.installPrioricodeIn": "ثبّت PrioriCode في {{distro}}.",
  "wsl.onboarding.installPrioricode": "تثبيت PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن PrioriCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على PrioriCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح PrioriCode.",
  ...
  "help.tabs.introduction": "أصبح PrioriCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من PrioriCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق PrioriCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (prioricode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن PrioriCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن PrioriCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم PrioriCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ PrioriCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور PrioriCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان PrioriCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة PrioriCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل PrioriCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من PrioriCode.",
