export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de PrioriCode",
  ...
  "desktop.menu.ariaLabel": "Menú de PrioriCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar PrioriCode",
  "desktop.recovery.terminated": "La ventana de PrioriCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "PrioriCode no responde",
  ...
  "desktop.wsl.error.installPrioricode": "No se pudo instalar PrioriCode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.prioricodeMissing": "prioricode no está instalado en esta distribución",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de PrioriCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.prioricode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.prioricodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.prioricodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en prioricode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de PrioriCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingPrioricode": "Comprobando PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Comprobando PrioriCode en {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Actualizando PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Actualizando PrioriCode en {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Actualiza PrioriCode en {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Actualizar PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode está listo en {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode está listo.",
  "wsl.onboarding.installPrioricodeIn": "Instala PrioriCode en {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instalar PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que PrioriCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de PrioriCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de PrioriCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (prioricode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: PrioriCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor PrioriCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve PrioriCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si PrioriCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de PrioriCode.",
