...
export const dict = {
  ...
  "dialog.provider.prioricode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.prioricode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.prioricodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in PrioriCode zu nutzen.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in PrioriCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in PrioriCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In prioricode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den PrioriCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode wird geprüft…",
  "wsl.onboarding.checkingPrioricodeIn": "PrioriCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingPrioricode": "PrioriCode wird aktualisiert…",
  "wsl.onboarding.updatingPrioricodeIn": "PrioriCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updatePrioricodeIn": "Aktualisieren Sie PrioriCode in {{distro}}.",
  "wsl.onboarding.updatePrioricode": "PrioriCode aktualisieren",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode ist in {{distro}} bereit.",
  "wsl.onboarding.prioricodeReady": "PrioriCode ist bereit.",
  "wsl.onboarding.installPrioricodeIn": "Installieren Sie PrioriCode in {{distro}}.",
  "wsl.onboarding.installPrioricode": "PrioriCode installieren",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor PrioriCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann PrioriCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von PrioriCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem PrioriCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (prioricode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: PrioriCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "PrioriCode Desktop",
  ...
  "settings.desktop.wsl.description": "PrioriCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für PrioriCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie PrioriCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob PrioriCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von PrioriCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von PrioriCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "PrioriCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von PrioriCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "PrioriCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das PrioriCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "PrioriCode reagiert nicht",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.prioricodeMissing": "prioricode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das PrioriCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "PrioriCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
