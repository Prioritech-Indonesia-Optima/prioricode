...
const desktop = [
  ...
  "Kilépés",
  "Az PrioriCode betöltése sikertelen",
  "Az PrioriCode ablaka váratlanul leállt",
  "Az PrioriCode nem válaszol",
  ...
  "Az PrioriCode telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az prioricode nincs telepítve ebben a disztribúcióban",
  "Az prioricode telepítve van, de nem futtatható",
  "Az PrioriCode nincs telepítve ebben: {{distro}}",
  "Az PrioriCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.prioricode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.prioricode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.prioricodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A PrioriCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a PrioriCode-ben.",
  ...
  "provider.connect.prioricodeZen.line1":
    "A PrioriCode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Látogatás",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a PrioriCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a PrioriCode-ben.",
  ...
  "dialog.plugins.empty": "Az prioricode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik PrioriCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode ellenőrzése...",
  "wsl.onboarding.checkingPrioricodeIn": "PrioriCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode frissítése...",
  "wsl.onboarding.updatingPrioricodeIn": "PrioriCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updatePrioricodeIn": "Frissítse a PrioriCode-t a {{distro}}-ben.",
  "wsl.onboarding.updatePrioricode": "Frissítse a PrioriCode-t",
  "wsl.onboarding.prioricodeReadyIn": "A PrioriCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.prioricodeReady": "A PrioriCode készen áll.",
  "wsl.onboarding.installPrioricodeIn": "Telepítse a PrioriCode-t a {{distro}}-be.",
  "wsl.onboarding.installPrioricode": "Telepítse a PrioriCode-t",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "A PrioriCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a PrioriCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A PrioriCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a PrioriCode programot.",
  ...
  "help.tabs.introduction": "A PrioriCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A PrioriCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a PrioriCode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (prioricode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a PrioriCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A PrioriCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "PrioriCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a PrioriCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a PrioriCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a PrioriCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a PrioriCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a PrioriCode témáját.",
  ...
  "settings.updates.row.startup.description": "A PrioriCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a PrioriCode legújabb verzióját futtatja.",
