export const dict = {
  ...
  "desktop.menu.documentation": "Документація PrioriCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити PrioriCode",
  "desktop.recovery.terminated": "Роботу вікна PrioriCode несподівано завершено",
  "desktop.recovery.unresponsive": "PrioriCode не відповідає",
  ...
  "desktop.wsl.error.installPrioricode": "Не вдалося встановити PrioriCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.prioricodeMissing": "prioricode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення PrioriCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.prioricode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.prioricodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у PrioriCode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в prioricode.json",
  ...
  "dialog.server.description": "Перемкніть сервер PrioriCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingPrioricode": "Перевірка PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Перевірка PrioriCode у {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Оновлення PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Оновлення PrioriCode у {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Оновіть PrioriCode у {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Оновити PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode готовий до роботи.",
  "wsl.onboarding.installPrioricodeIn": "Встановіть PrioriCode у {{distro}}.",
  "wsl.onboarding.installPrioricode": "Встановити PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в PrioriCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія PrioriCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді PrioriCode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (prioricode.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, PrioriCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер PrioriCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу PrioriCode",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію PrioriCode.",
