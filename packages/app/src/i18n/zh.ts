...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode 加载失败",
  "desktop.recovery.terminated": "PrioriCode 窗口意外终止",
  "desktop.recovery.unresponsive": "PrioriCode 未响应",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.prioricodeMissing": "此发行版中未安装 prioricode",
  "desktop.wsl.error.prioricodeCannotRun": "已安装 prioricode，但无法运行",
  "desktop.wsl.error.prioricodeNotInstalled": "{{distro}} 中未安装 PrioriCode",
  "desktop.wsl.error.updateVersion":
    "PrioriCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.prioricode.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.prioricode.tagline": "可靠的优化模型",
  "dialog.provider.prioricodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 PrioriCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.prioricodeZen.line1": "PrioriCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.prioricodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.prioricodeZen.visit.prefix": "访问 ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 PrioriCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 PrioriCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 prioricode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 PrioriCode 服务器。",
  ...
  "wsl.onboarding.checkingPrioricode": "正在检查 PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "正在检查 {{distro}} 中的 PrioriCode...",
  "wsl.onboarding.updatingPrioricode": "正在更新 PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "正在更新 {{distro}} 中的 PrioriCode...",
  "wsl.onboarding.updatePrioricodeIn": "更新 {{distro}} 中的 PrioriCode。",
  "wsl.onboarding.updatePrioricode": "更新 PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "{{distro}} 中的 PrioriCode 已就绪。",
  "wsl.onboarding.prioricodeReady": "PrioriCode 已就绪。",
  "wsl.onboarding.installPrioricodeIn": "在 {{distro}} 中安装 PrioriCode。",
  "wsl.onboarding.installPrioricode": "安装 PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "未安装 PrioriCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "PrioriCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 PrioriCode。",
  ...
  "help.tabs.introduction": "PrioriCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 PrioriCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (prioricode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：PrioriCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 PrioriCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 PrioriCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 PrioriCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 PrioriCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 PrioriCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 PrioriCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 PrioriCode。",
