export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "PrioriCode մենյու",
  ...
  "desktop.recovery.loadFailed": "PrioriCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "PrioriCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "PrioriCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.prioricodeMissing": "prioricode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.prioricode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.prioricodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և PrioriCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և PrioriCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և PrioriCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են prioricode.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ PrioriCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingPrioricode": "Ստուգում է PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Ստուգում է PrioriCode-ը {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Թարմացվում է PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Թարմացվում է PrioriCode-ը {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Թարմացնել PrioriCode-ը {{distro}}-ում։",
  "wsl.onboarding.updatePrioricode": "Թարմացնել PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.prioricodeReady": "PrioriCode պատրաստ է։",
  "wsl.onboarding.installPrioricodeIn": "Տեղադրեք PrioriCode-ը {{distro}}-ում։",
  "wsl.onboarding.installPrioricode": "Տեղադրեք PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի PrioriCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք PrioriCode։",
  ...
  "help.tabs.introduction": "PrioriCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին PrioriCode թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (prioricode.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ PrioriCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "PrioriCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք PrioriCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն PrioriCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է PrioriCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ PrioriCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է PrioriCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ PrioriCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք PrioriCode-ի վերջին տարբերակը։",
