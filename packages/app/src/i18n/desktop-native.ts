...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode failed to load",
  "desktop.recovery.terminated": "PrioriCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "PrioriCode is not responding",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.prioricodeMissing": "prioricode is not installed in this distro",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode is installed but could not run",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
