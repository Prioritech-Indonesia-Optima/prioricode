export const dict = {
  ...
  "dialog.provider.prioricode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.prioricode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.prioricodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Besøg ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i prioricode.json",
  ...
  "dialog.server.description": "Skift hvilken PrioriCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingPrioricode": "Tjekker PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Tjekker PrioriCode i {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Opdaterer PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Opdaterer PrioriCode i {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Opdater PrioriCode i {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Opdater PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før PrioriCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter PrioriCode igen.",
  ...
  "toast.update.description": "En ny version af PrioriCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til PrioriCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (prioricode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, PrioriCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør PrioriCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for PrioriCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan PrioriCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om PrioriCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas PrioriCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når PrioriCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af PrioriCode.",
  ...
  "desktop.recovery.loadFailed": "PrioriCode kunne ikke indlæses",
  "desktop.recovery.terminated": "PrioriCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installPrioricode": "Installationen af PrioriCode mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.prioricodeMissing": "prioricode er ikke installeret i denne distribution",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode er installeret, men kunne ikke køre",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af PrioriCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "PrioriCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
