export const dict = {
  ...
  "dialog.provider.prioricode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.prioricode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.prioricodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja PrioriCodessa.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Avaa ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja PrioriCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja PrioriCodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään prioricode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda PrioriCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingPrioricode": "Tarkistetaan PrioriCodea...",
  "wsl.onboarding.checkingPrioricodeIn": "Tarkistetaan PrioriCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Päivitetään PrioriCodea...",
  "wsl.onboarding.updatingPrioricodeIn": "Päivitetään PrioriCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Päivitä PrioriCode jakelussa {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Päivitä PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode on valmis.",
  "wsl.onboarding.installPrioricodeIn": "Asenna PrioriCode jakeluun {{distro}}.",
  "wsl.onboarding.installPrioricode": "Asenna PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin PrioriCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten PrioriCode uudelleen.",
  ...
  "toast.update.description": "PrioriCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä PrioriCode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (prioricode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että PrioriCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita PrioriCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda PrioriCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä PrioriCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö PrioriCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta PrioriCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun PrioriCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät PrioriCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "PrioriCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "PrioriCode-valikko",
  ...
  "desktop.recovery.loadFailed": "PrioriCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "PrioriCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "PrioriCode ei vastaa",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.prioricodeMissing": "prioricodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "PrioriCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
