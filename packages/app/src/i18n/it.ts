export const dict = {
  ...
  "dialog.provider.prioricode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.prioricode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.prioricodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.prioricodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.prioricodeZen.visit.prefix": "Visita ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in prioricode.json",
  ...
  "dialog.server.description": "Cambia il server PrioriCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingPrioricode": "Controllo PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Controllo PrioriCode in {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Aggiornamento PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Aggiornamento PrioriCode in {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Aggiorna PrioriCode in {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Aggiorna PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode è pronto in {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode è pronto.",
  "wsl.onboarding.installPrioricodeIn": "Installa PrioriCode in {{distro}}.",
  "wsl.onboarding.installPrioricode": "Installa PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che PrioriCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di PrioriCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team PrioriCode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (prioricode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: PrioriCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server PrioriCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di PrioriCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se PrioriCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di PrioriCode",
  ...
  "settings.updates.toast.latest.title": "PrioriCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di PrioriCode.",
  ...
  "desktop.menu.documentation": "Documentazione di PrioriCode",
  ...
  "desktop.menu.ariaLabel": "Menu PrioriCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare PrioriCode",
  "desktop.recovery.terminated": "La finestra di PrioriCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "PrioriCode non risponde",
  ...
  "desktop.wsl.error.installPrioricode": "Installazione di PrioriCode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.prioricodeMissing": "prioricode non è installato in questa distribuzione",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di PrioriCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
