export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode yüklənə bilmədi",
  "desktop.recovery.terminated": "PrioriCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "PrioriCode cavab vermir",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.prioricodeMissing": "Bu distribütivdə prioricode quraşdırılmayıb",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "PrioriCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.prioricode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.prioricodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və PrioriCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və PrioriCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və PrioriCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər prioricode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu PrioriCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode yoxlanılır...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}}-də PrioriCode yoxlanılır...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode yenilənir...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}}-də PrioriCode yenilənir...",
  "wsl.onboarding.updatePrioricodeIn": "{{distro}}-də PrioriCode-u yeniləyin.",
  "wsl.onboarding.updatePrioricode": "PrioriCode-u yeniləyin",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode {{distro}}-də hazırdır.",
  "wsl.onboarding.prioricodeReady": "PrioriCode hazırdır.",
  "wsl.onboarding.installPrioricodeIn": "PrioriCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installPrioricode": "PrioriCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PrioriCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra PrioriCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı PrioriCode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (prioricode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: PrioriCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində PrioriCode serverini işlət.",
  ...
  "settings.general.row.language.description": "PrioriCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "PrioriCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "PrioriCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "PrioriCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "PrioriCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "PrioriCode-un ən son versiyasından istifadə edirsiniz.",
