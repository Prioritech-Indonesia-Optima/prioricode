export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด PrioriCode ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง PrioriCode หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "PrioriCode ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installPrioricode": "การติดตั้ง PrioriCode ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.prioricodeMissing": "ไม่ได้ติดตั้ง prioricode ในดิสโทรนี้",
  "desktop.wsl.error.prioricodeCannotRun": "ติดตั้ง prioricode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.prioricodeNotInstalled": "ไม่ได้ติดตั้ง PrioriCode ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต PrioriCode เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.prioricode.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.prioricode.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.prioricodeGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน PrioriCode",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.prioricodeZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.prioricodeZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน PrioriCode",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน PrioriCode",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน prioricode.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ PrioriCode ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingPrioricode": "กำลังตรวจสอบ PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "กำลังตรวจสอบ PrioriCode ใน {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "กำลังอัปเดต PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "กำลังอัปเดต PrioriCode ใน {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "อัปเดต PrioriCode ใน {{distro}}",
  "wsl.onboarding.updatePrioricode": "อัปเดต PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.prioricodeReady": "PrioriCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installPrioricodeIn": "ติดตั้ง PrioriCode ใน {{distro}}",
  "wsl.onboarding.installPrioricode": "ติดตั้ง PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "ยังไม่ได้ติดตั้ง PrioriCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ PrioriCode จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด PrioriCode อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ PrioriCode Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ PrioriCode ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม PrioriCode",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (prioricode.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า PrioriCode ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ PrioriCode ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ PrioriCode",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ PrioriCode บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ PrioriCode ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ PrioriCode",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ PrioriCode เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน PrioriCode เวอร์ชันล่าสุด",
