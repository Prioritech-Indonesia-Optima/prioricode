export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "PrioriCode menýusy",
  ...
  "desktop.recovery.loadFailed": "PrioriCode ýükläp bilmedi",
  "desktop.recovery.terminated": "PrioriCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "PrioriCode jogap berenok",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.prioricodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "PrioriCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.prioricode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.prioricodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we PrioriCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Sapar ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini PrioriCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini PrioriCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "prioricode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy PrioriCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode barlamak ...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}} içinde PrioriCode barlanýar...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode täzelenmek ...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}}-de PrioriCode täzelenmek ...",
  "wsl.onboarding.updatePrioricodeIn": "PrioriCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updatePrioricode": "PrioriCode täzeläň",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode {{distro}}-de taýýar.",
  "wsl.onboarding.prioricodeReady": "PrioriCode taýýar.",
  "wsl.onboarding.installPrioricodeIn": "{{distro}}-de PrioriCode guruň.",
  "wsl.onboarding.installPrioricode": "PrioriCode guruň",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) PrioriCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra PrioriCode açyň.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin PrioriCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy PrioriCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (prioricode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, PrioriCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "PrioriCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "PrioriCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "PrioriCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "PrioriCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "PrioriCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "PrioriCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "PrioriCode-iň iň soňky wersiýasyny işleýärsiňiz.",
