export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "PrioriCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "PrioriCode ei vasta",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.prioricodeMissing": "prioricode pole sellesse distrosse installitud",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.prioricode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.prioricodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid PrioriCode'is.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Külastage ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises PrioriCode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis prioricode.json",
  ...
  "dialog.server.description": "Lülitage, millise PrioriCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode kontrollimine...",
  "wsl.onboarding.checkingPrioricodeIn": "PrioriCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode värskendamine...",
  "wsl.onboarding.updatingPrioricodeIn": "PrioriCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Värskenda PrioriCode jaotises {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Värskenda PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode on valmis {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode on valmis.",
  "wsl.onboarding.installPrioricodeIn": "Installige PrioriCode asukohta {{distro}}.",
  "wsl.onboarding.installPrioricode": "Installige PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui PrioriCode saab lisada WSL serveri",
  ...
  "help.tabs.introduction": "PrioriCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse PrioriCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast PrioriCode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (prioricode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, PrioriCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "PrioriCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage PrioriCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke PrioriCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas PrioriCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas PrioriCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas PrioriCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui PrioriCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse PrioriCode uusimat versiooni.",
