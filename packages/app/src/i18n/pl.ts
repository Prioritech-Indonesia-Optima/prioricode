export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja PrioriCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać PrioriCode",
  "desktop.recovery.terminated": "Okno PrioriCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "PrioriCode nie odpowiada",
  ...
  "desktop.wsl.error.installPrioricode": "Nie udało się zainstalować PrioriCode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.prioricodeMissing": "Program prioricode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.prioricodeCannotRun": "Program prioricode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja PrioriCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.prioricode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.prioricodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w PrioriCode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku prioricode.json",
  ...
  "dialog.server.description": "Przełącz serwer PrioriCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingPrioricode": "Sprawdzanie PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Sprawdzanie PrioriCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Aktualizowanie PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Aktualizowanie PrioriCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Zaktualizuj PrioriCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Zaktualizuj PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode jest gotowy.",
  "wsl.onboarding.installPrioricodeIn": "Zainstaluj PrioriCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installPrioricode": "Zainstaluj PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim PrioriCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja PrioriCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu PrioriCode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (prioricode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: PrioriCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "PrioriCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer PrioriCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla PrioriCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd PrioriCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy PrioriCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji PrioriCode.",
