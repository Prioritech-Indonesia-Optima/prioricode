export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCodeを読み込めませんでした",
  "desktop.recovery.terminated": "PrioriCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "PrioriCodeが応答していません",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.prioricodeMissing": "このディストリビューションにはprioricodeがインストールされていません",
  "desktop.wsl.error.prioricodeCannotRun": "prioricodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.prioricodeNotInstalled": "{{distro}}にはPrioriCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "PrioriCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.prioricode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.prioricode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.prioricodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、PrioriCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.prioricodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.prioricodeZen.visit.prefix": " ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してPrioriCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、PrioriCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "prioricode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するPrioriCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCodeを確認中...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}}内のPrioriCodeを確認中...",
  "wsl.onboarding.updatingPrioricode": "PrioriCodeを更新中...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}}内のPrioriCodeを更新中...",
  "wsl.onboarding.updatePrioricodeIn": "{{distro}}内のPrioriCodeを更新してください。",
  "wsl.onboarding.updatePrioricode": "PrioriCodeを更新",
  "wsl.onboarding.prioricodeReadyIn": "{{distro}}内のPrioriCodeの準備ができました。",
  "wsl.onboarding.prioricodeReady": "PrioriCodeの準備ができました。",
  "wsl.onboarding.installPrioricodeIn": "{{distro}}にPrioriCodeをインストールしてください。",
  "wsl.onboarding.installPrioricode": "PrioriCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PrioriCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、PrioriCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "PrioriCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをPrioriCodeチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "PrioriCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でPrioriCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "PrioriCodeの表示言語を変更します",
  ...
  "settings.updates.row.startup.description": "PrioriCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "PrioriCode は最新バージョンです。",
