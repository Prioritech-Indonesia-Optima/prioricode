export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "PrioriCode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "PrioriCode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "PrioriCode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.prioricodeMissing": "اس ڈسٹرو وچ prioricode انسٹال نئیں اے",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.prioricodeNotInstalled": "{{distro}} وچ PrioriCode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "PrioriCode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.prioricode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.prioricode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.prioricodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے PrioriCode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "ویکھو ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے PrioriCode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے PrioriCode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "prioricode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس PrioriCode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode چیک کر رئے آں...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}} چ PrioriCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}} وچ PrioriCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatePrioricodeIn": "{{distro}} وچ PrioriCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updatePrioricode": "PrioriCode اپ ڈیٹ کرو",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.prioricodeReady": "PrioriCode تیار اے۔",
  "wsl.onboarding.installPrioricodeIn": "{{distro}} وچ PrioriCode انسٹال کرو۔",
  "wsl.onboarding.installPrioricode": "PrioriCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PrioriCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر PrioriCode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "PrioriCode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع PrioriCode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (prioricode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، PrioriCode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر PrioriCode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "PrioriCode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے PrioriCode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا PrioriCode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "PrioriCode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں PrioriCode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی PrioriCode دا تازہ ترین ورژن چلا رئے او۔",
