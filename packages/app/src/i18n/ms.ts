export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi PrioriCode",
  ...
  "desktop.recovery.loadFailed": "PrioriCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap PrioriCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "PrioriCode tidak memberi respons",
  ...
  "desktop.wsl.error.installPrioricode": "Pemasangan PrioriCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.prioricodeMissing": "prioricode tidak dipasang dalam distro ini",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini PrioriCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.prioricode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.prioricodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Layari",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam prioricode.json",
  ...
  "dialog.server.description": "Tukar pelayan PrioriCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingPrioricode": "Sedang menyemak PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Sedang menyemak PrioriCode dalam {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Sedang mengemas kini PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Sedang mengemas kini PrioriCode dalam {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Kemas kini PrioriCode dalam {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Kemas kini PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode sedia digunakan.",
  "wsl.onboarding.installPrioricodeIn": "Pasang PrioriCode dalam {{distro}}.",
  "wsl.onboarding.installPrioricode": "Pasang PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum PrioriCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu PrioriCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan PrioriCode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (prioricode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, PrioriCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan PrioriCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk PrioriCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa PrioriCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada PrioriCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila PrioriCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini PrioriCode.",
