export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode መጫን አልቻለም",
  "desktop.recovery.terminated": "PrioriCode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "PrioriCode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCodeመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.prioricodeMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.prioricodeCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "PrioriCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.prioricode.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.prioricodeGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በPrioriCode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በPrioriCode ይጠቀሙ።",
  ...
  "provider.connect.prioricodeZen.line1": "PrioriCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.prioricodeZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.prioricodeZen.visit.prefix": "ጎብኝ ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በPrioriCode ውስጥ ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ prioricode.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው PrioriCode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingPrioricode": "መፈተሽ PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "PrioriCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingPrioricode": "በማዘመን ላይ PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "በማዘመን ላይ PrioriCode በ{{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "አዘምን PrioriCode በ{{distro}}።",
  "wsl.onboarding.updatePrioricode": "አዘምን PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.prioricodeReady": "PrioriCode ዝግጁ ነው።",
  "wsl.onboarding.installPrioricodeIn": "መጫን PrioriCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installPrioricode": "ጫን PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) PrioriCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ PrioriCode።",
  ...
  "help.tabs.introduction": "PrioriCode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የPrioriCode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለPrioriCode ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (prioricode.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ PrioriCode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "PrioriCode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የPrioriCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለPrioriCode",
  ...
  "settings.general.row.appearance.description": "PrioriCodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "PrioriCode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "PrioriCode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "PrioriCode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የPrioriCode እትም እያሄዱ ነው።",
