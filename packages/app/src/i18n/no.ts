...
export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "PrioriCode-meny",
  ...
  "desktop.recovery.loadFailed": "PrioriCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "PrioriCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "PrioriCode svarer ikke",
  ...
  "desktop.wsl.error.installPrioricode": "Installasjonen av PrioriCode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.prioricodeMissing": "prioricode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av PrioriCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.prioricode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.prioricodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Besøk ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i PrioriCode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i prioricode.json",
  ...
  "dialog.server.description": "Bytt hvilken PrioriCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av PrioriCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til PrioriCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (prioricode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at PrioriCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør PrioriCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for PrioriCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan PrioriCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om PrioriCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når PrioriCode starter",
  ...
  "settings.updates.toast.latest.title": "PrioriCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av PrioriCode.",
  ...
  "wsl.onboarding.checkingPrioricode": "Sjekker PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Sjekker PrioriCode i {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Oppdaterer PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Oppdaterer PrioriCode i {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Oppdater PrioriCode i {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Oppdater PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode er klar i {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode er klar.",
  "wsl.onboarding.installPrioricodeIn": "Installer PrioriCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før PrioriCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter PrioriCode på nytt.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
