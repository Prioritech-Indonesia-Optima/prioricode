export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do PrioriCode",
  ...
  "desktop.menu.ariaLabel": "Menu do PrioriCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o PrioriCode",
  "desktop.recovery.terminated": "A janela do PrioriCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O PrioriCode não está respondendo",
  ...
  "desktop.wsl.error.installPrioricode": "Falha na instalação do PrioriCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.prioricodeMissing": "O prioricode não está instalado nesta distribuição",
  "desktop.wsl.error.prioricodeCannotRun": "O prioricode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.prioricodeNotInstalled": "O PrioriCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do PrioriCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.prioricode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.prioricodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Visite ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em prioricode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor PrioriCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingPrioricode": "Verificando o PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Verificando o PrioriCode em {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Atualizando o PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Atualizando o PrioriCode em {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Atualize o PrioriCode em {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Atualizar o PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "O PrioriCode está pronto em {{distro}}.",
  "wsl.onboarding.prioricodeReady": "O PrioriCode está pronto.",
  "wsl.onboarding.installPrioricodeIn": "Instale o PrioriCode em {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instalar o PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o PrioriCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O PrioriCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o PrioriCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o PrioriCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do PrioriCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do PrioriCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (prioricode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: PrioriCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor PrioriCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o PrioriCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o PrioriCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o PrioriCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o PrioriCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do PrioriCode.",
