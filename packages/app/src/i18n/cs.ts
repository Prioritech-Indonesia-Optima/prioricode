export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka PrioriCode",
  ...
  "desktop.recovery.loadFailed": "PrioriCode se nepodařilo načíst",
  "desktop.recovery.terminated": "PrioriCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "PrioriCode nereaguje",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.prioricodeMissing": "prioricode není v této distribuci nainstalováno",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.prioricode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.prioricodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Návštěva ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v PrioriCode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v prioricode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému PrioriCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingPrioricode": "Kontrola PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Kontrola PrioriCode v {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Aktualizace PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Aktualizace PrioriCode v {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Aktualizace PrioriCode v {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Aktualizovat PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode je připraveno v {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode je připraven.",
  "wsl.onboarding.installPrioricodeIn": "Nainstalujte PrioriCode do {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instalovat PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než PrioriCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze PrioriCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu PrioriCode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (prioricode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: PrioriCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server PrioriCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro PrioriCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled PrioriCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude PrioriCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi PrioriCode.",
