...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "PrioriCode se nije uspio učitati",
  "Prozor aplikacije PrioriCode neočekivano je zatvoren",
  "PrioriCode ne reagira",
  ...
  "Instalacija aplikacije PrioriCode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "prioricode nije instaliran u ovoj distribuciji",
  "prioricode je instaliran, ali se ne može pokrenuti",
  "PrioriCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije PrioriCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.prioricode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.prioricode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.prioricodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Posjetiti",
  "provider.connect.prioricodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u PrioriCode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u prioricode.json",
  ...
  "dialog.server.description": "Promijenite na koji se PrioriCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingPrioricodeIn": "Provjera PrioriCode u {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Ažuriranje PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Ažuriranje PrioriCode u {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Ažurirajte PrioriCode u {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Ažurirajte PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode je spreman u {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode je spreman.",
  "wsl.onboarding.installPrioricodeIn": "Instalirajte PrioriCode u {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instalirajte PrioriCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što PrioriCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite PrioriCode.",
  ...
  "help.tabs.introduction": "Radna površina PrioriCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija PrioriCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku PrioriCode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (prioricode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, PrioriCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "PrioriCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite PrioriCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za PrioriCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako PrioriCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li PrioriCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je PrioriCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se PrioriCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju PrioriCode.",
