export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "PrioriCode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt PrioriCode",
  "desktop.recovery.terminated": "PrioriCode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "PrioriCode neatbild",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.prioricodeMissing": "prioricode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.prioricode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.prioricodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus PrioriCode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti prioricode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura PrioriCode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingPrioricode": "Pārbaudu PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Pārbaudu PrioriCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Atjauninu PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Atjauninu PrioriCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Atjauniniet PrioriCode distribūcijā {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Atjauniniet PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode ir gatavs.",
  "wsl.onboarding.installPrioricodeIn": "Instalējiet PrioriCode distribūcijā {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instalējiet PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms PrioriCode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet PrioriCode no jauna.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna PrioriCode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu PrioriCode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (prioricode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, PrioriCode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "PrioriCode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist PrioriCode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt PrioriCode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā PrioriCode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai PrioriCode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet PrioriCode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko PrioriCode versiju.",
