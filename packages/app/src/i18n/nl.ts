export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "PrioriCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het PrioriCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "PrioriCode reageert niet",
  ...
  "desktop.wsl.error.installPrioricode": "Installatie van PrioriCode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.prioricodeMissing": "prioricode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De PrioriCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.prioricode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.prioricodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in PrioriCode te gebruiken.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Ga naar ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in PrioriCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in PrioriCode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in prioricode.json",
  ...
  "dialog.server.description": "Wijzig met welke PrioriCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode controleren...",
  "wsl.onboarding.checkingPrioricodeIn": "PrioriCode controleren in {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode bijwerken...",
  "wsl.onboarding.updatingPrioricodeIn": "PrioriCode bijwerken in {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Werk PrioriCode bij in {{distro}}.",
  "wsl.onboarding.updatePrioricode": "PrioriCode bijwerken",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode is gereed in {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode is klaar.",
  "wsl.onboarding.installPrioricodeIn": "Installeer PrioriCode in {{distro}}.",
  "wsl.onboarding.installPrioricode": "Installeer PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat PrioriCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens PrioriCode opnieuw.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van PrioriCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het PrioriCode-team",
  ...
  "sidebar.gettingStarted.line1": "PrioriCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de PrioriCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor PrioriCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe PrioriCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of PrioriCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van PrioriCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer PrioriCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "PrioriCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van PrioriCode.",
