export const dict = {
  ...
  "desktop.menu.documentation": "Documentație PrioriCode",
  ...
  "desktop.menu.ariaLabel": "Meniu PrioriCode",
  ...
  "desktop.recovery.loadFailed": "PrioriCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra PrioriCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "PrioriCode nu răspunde",
  ...
  "desktop.wsl.error.installPrioricode": "Instalarea PrioriCode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.prioricodeMissing": "prioricode nu este instalat în această distribuție",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea PrioriCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.prioricode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.prioricodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.prioricodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.prioricodeZen.visit.prefix": "Vizitează",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în PrioriCode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în prioricode.json",
  ...
  "dialog.server.description": "Schimbă serverul PrioriCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingPrioricode": "Se verifică PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Se verifică PrioriCode în {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Se actualizează PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Se actualizează PrioriCode în {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Actualizează PrioriCode în {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Actualizează PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode este gata în {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode este gata.",
  "wsl.onboarding.installPrioricodeIn": "Instalează PrioriCode în {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instalează PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca PrioriCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune PrioriCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei PrioriCode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (prioricode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, PrioriCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul PrioriCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul PrioriCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă PrioriCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune PrioriCode.",
