export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "PrioriCode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "PrioriCode लोड नहीं हो सका",
  "desktop.recovery.terminated": "PrioriCode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "PrioriCode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.prioricodeMissing": "इस डिस्ट्रो में prioricode इंस्टॉल नहीं है",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.prioricodeNotInstalled": "{{distro}} में PrioriCode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "PrioriCode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.provider.prioricode.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.prioricode.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.prioricodeGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और PrioriCode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और PrioriCode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा PrioriCode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन prioricode.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस PrioriCode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode की जाँच हो रही है...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}} में PrioriCode की जाँच हो रही है...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode अपडेट हो रहा है...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}} में PrioriCode अपडेट हो रहा है...",
  "wsl.onboarding.updatePrioricodeIn": "{{distro}} में PrioriCode को अपडेट करें।",
  "wsl.onboarding.updatePrioricode": "PrioriCode को अपडेट करें",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode {{distro}} में तैयार है।",
  "wsl.onboarding.prioricodeReady": "PrioriCode तैयार है।",
  "wsl.onboarding.installPrioricodeIn": "{{distro}} में PrioriCode स्थापित करें।",
  "wsl.onboarding.installPrioricode": "PrioriCode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PrioriCode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर PrioriCode को फिर से खोलें।",
  ...
  "help.tabs.introduction": "PrioriCode Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट PrioriCode टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (prioricode.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, PrioriCode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर PrioriCode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "PrioriCode के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.updates.row.startup.description": "PrioriCode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप PrioriCode का नवीनतम संस्करण चला रहे हैं।",
