export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú PrioriCode.",
  ...
  "desktop.recovery.loadFailed": "PrioriCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra PrioriCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "PrioriCode no respon",
  ...
  "desktop.wsl.error.installPrioricode": "La instal·lació de PrioriCode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.prioricodeMissing": "prioricode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.prioricode.tagline": "Models optimitzats fiables",
  "dialog.provider.prioricodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.prioricodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a PrioriCode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a prioricode.json",
  ...
  "dialog.server.description": "Canvia a quin PrioriCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingPrioricode": "S'està comprovant PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "S'està registrant PrioriCode a {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "S'està actualitzant PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "S'està actualitzant PrioriCode a {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Actualitza PrioriCode a {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Actualització PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode està llest a {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode està llest.",
  "wsl.onboarding.installPrioricodeIn": "Instal·leu PrioriCode a {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instal·la PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que PrioriCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de PrioriCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip PrioriCode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (prioricode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que PrioriCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "PrioriCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor PrioriCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu PrioriCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si PrioriCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de PrioriCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï PrioriCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de PrioriCode.",
