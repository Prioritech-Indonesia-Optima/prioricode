export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode kunde inte läsas in",
  "desktop.recovery.terminated": "PrioriCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "PrioriCode svarar inte",
  ...
  "desktop.wsl.error.installPrioricode": "Installationen av PrioriCode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.prioricodeMissing": "prioricode är inte installerat i den här distributionen",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode är installerat men kunde inte köras",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.prioricode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.prioricode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.prioricodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Besök ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i PrioriCode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i prioricode.json",
  ...
  "dialog.server.description": "Växla vilken PrioriCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingPrioricode": "Kontrollerar PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Kontrollerar PrioriCode i {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Uppdaterar PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Uppdaterar PrioriCode i {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Uppdatera PrioriCode i {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Uppdatera PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode är redo i {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode är redo.",
  "wsl.onboarding.installPrioricodeIn": "Installera PrioriCode i {{distro}}.",
  "wsl.onboarding.installPrioricode": "Installera PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan PrioriCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan PrioriCode igen.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av PrioriCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till PrioriCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (prioricode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, PrioriCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör PrioriCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för PrioriCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur PrioriCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om PrioriCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa PrioriCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när PrioriCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av PrioriCode.",
