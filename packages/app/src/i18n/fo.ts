export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "PrioriCode valmynd",
  ...
  "desktop.recovery.loadFailed": "PrioriCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "PrioriCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "PrioriCode svarar ikki",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.prioricodeMissing": "prioricode er ikki sett upp í hesi distro",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "PrioriCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.prioricode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.prioricode.tagline": "Álítandi optimerað modell",
  "dialog.provider.prioricodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.prioricodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.prioricodeZen.visit.prefix": "Vitja ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í PrioriCode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í prioricode.json",
  ...
  "dialog.server.description": "Skift hvønn PrioriCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingPrioricode": "Kanna PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Kanna PrioriCode í {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Dagføring PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Dagføring PrioriCode í {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Dagfør PrioriCode í {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Dagfør PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode er klárt í {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode er klárt.",
  "wsl.onboarding.installPrioricodeIn": "Set PrioriCode upp í {{distro}}.",
  "wsl.onboarding.installPrioricode": "Set upp PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn PrioriCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani PrioriCode aftur.",
  ...
  "help.tabs.introduction": "PrioriCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av PrioriCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til PrioriCode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (prioricode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, PrioriCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "PrioriCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr PrioriCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri PrioriCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu PrioriCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um PrioriCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu PrioriCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá PrioriCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av PrioriCode.",
