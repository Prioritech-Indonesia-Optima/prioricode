export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za PrioriCode",
  ...
  "desktop.menu.ariaLabel": "PrioriCode meni",
  ...
  "desktop.recovery.loadFailed": "PrioriCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor PrioriCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "PrioriCode ne reaguje",
  ...
  "desktop.wsl.error.installPrioricode": "Instalacija PrioriCode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.prioricodeMissing": "prioricode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje PrioriCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.prioricode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.prioricodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u PrioriCode-u.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Posjeti ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u PrioriCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u PrioriCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u prioricode.json",
  ...
  "dialog.server.description": "Promijeni na koji se PrioriCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingPrioricode": "Provjera PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Provjera PrioriCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Ažuriranje PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Ažuriranje PrioriCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Ažuriraj PrioriCode u distribuciji {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Ažuriraj PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode je spreman.",
  "wsl.onboarding.installPrioricodeIn": "Instaliraj PrioriCode u distribuciji {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instaliraj PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi PrioriCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija PrioriCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku PrioriCode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (prioricode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: PrioriCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni PrioriCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u PrioriCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako PrioriCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li PrioriCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu PrioriCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se PrioriCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju PrioriCode-a.",
