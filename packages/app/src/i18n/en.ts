...
export const dict = {
  ...
  "dialog.provider.prioricode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.prioricode.tagline": "Reliable optimized models",
  "dialog.provider.prioricodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in PrioriCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.prioricodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.prioricodeZen.visit.prefix": "Visit ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in prioricode.json",
  ...
  "dialog.server.description": "Switch which PrioriCode server this app connects to.",
  ...
  "wsl.onboarding.checkingPrioricode": "Checking PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Checking PrioriCode in {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Updating PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Updating PrioriCode in {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Update PrioriCode in {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Update PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode is ready in {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode is ready.",
  "wsl.onboarding.installPrioricodeIn": "Install PrioriCode in {{distro}}.",
  "wsl.onboarding.installPrioricode": "Install PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before PrioriCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of PrioriCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the PrioriCode team",
  ...
  "error.chain.checkConfig": "Check your config (prioricode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, PrioriCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the PrioriCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for PrioriCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how PrioriCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether PrioriCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how PrioriCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when PrioriCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of PrioriCode.",
