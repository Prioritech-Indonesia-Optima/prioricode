export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni PrioriCode",
  ...
  "desktop.menu.ariaLabel": "Menuja PrioriCode",
  ...
  "desktop.recovery.loadFailed": "PrioriCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja PrioriCode u mbyll papritur",
  "desktop.recovery.unresponsive": "PrioriCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installPrioricode": "Instalimi i PrioriCode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.prioricodeMissing": "Prioricode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.prioricodeCannotRun": "Prioricode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i PrioriCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.prioricode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.prioricodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në PrioriCode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në prioricode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server PrioriCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingPrioricode": "Po kontrollon PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Po kontrollon PrioriCode në {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode po përditësohet...",
  "wsl.onboarding.updatingPrioricodeIn": "Po përditëson PrioriCode në {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Përditëso PrioriCode në {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Përditëso PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode është gati në {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode është gati.",
  "wsl.onboarding.installPrioricodeIn": "Instaloni PrioriCode në {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instaloni PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se PrioriCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i PrioriCode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (prioricode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, PrioriCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin PrioriCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket PrioriCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse PrioriCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të PrioriCode.",
