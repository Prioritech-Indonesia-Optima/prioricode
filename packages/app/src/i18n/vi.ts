export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu PrioriCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được PrioriCode",
  "desktop.recovery.terminated": "Cửa sổ PrioriCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "PrioriCode không phản hồi",
  ...
  "desktop.wsl.error.installPrioricode": "Không cài đặt được PrioriCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.prioricodeMissing": "prioricode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật PrioriCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.prioricode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.prioricodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do PrioriCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Truy cập ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong PrioriCode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong prioricode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ PrioriCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingPrioricode": "Đang kiểm tra PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Đang kiểm tra PrioriCode trong {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Đang cập nhật PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Đang cập nhật PrioriCode trong {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Cập nhật PrioriCode trong {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Cập nhật PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode đã sẵn sàng.",
  "wsl.onboarding.installPrioricodeIn": "Cài đặt PrioriCode trong {{distro}}.",
  "wsl.onboarding.installPrioricode": "Cài đặt PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi PrioriCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của PrioriCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm PrioriCode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (prioricode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: PrioriCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ PrioriCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho PrioriCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của PrioriCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem PrioriCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi PrioriCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của PrioriCode.",
