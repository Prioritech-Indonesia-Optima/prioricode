...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða PrioriCode",
  "PrioriCode-glugganum var óvænt lokað",
  "PrioriCode svarar ekki",
  ...
  "Uppsetning PrioriCode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "prioricode er ekki uppsett í þessari dreifingu",
  "prioricode er uppsett en ekki var hægt að keyra það",
  "PrioriCode er ekki uppsett í {{distro}}",
  "Uppfærslu PrioriCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.prioricode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.prioricode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.prioricodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.prioricodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.prioricodeZen.visit.prefix": "Heimsókn",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í PrioriCode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í prioricode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða PrioriCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingPrioricode": "Athugar PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Athugar PrioriCode í {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Uppfærir PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Uppfærir PrioriCode í {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Uppfærðu PrioriCode í {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Uppfærðu PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode er tilbúið í {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode er tilbúinn.",
  "wsl.onboarding.installPrioricodeIn": "Settu upp PrioriCode í {{distro}}.",
  "wsl.onboarding.installPrioricode": "Settu upp PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en PrioriCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan PrioriCode aftur.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af PrioriCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til PrioriCode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (prioricode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, PrioriCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "PrioriCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "PrioriCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu PrioriCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir PrioriCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig PrioriCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort PrioriCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig PrioriCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar PrioriCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af PrioriCode.",
