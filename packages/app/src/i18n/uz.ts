export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "PrioriCode menyusi",
  ...
  "desktop.recovery.loadFailed": "PrioriCode yuklanmadi",
  "desktop.recovery.terminated": "PrioriCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "PrioriCode javob bermayapti",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.prioricodeMissing": "Prioricode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "PrioriCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.prioricode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.prioricodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va PrioriCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va PrioriCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va PrioriCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "prioricode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi PrioriCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode tekshirilmoqda...",
  "wsl.onboarding.checkingPrioricodeIn": "PrioriCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode yangilanmoqda...",
  "wsl.onboarding.updatingPrioricodeIn": "PrioriCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updatePrioricodeIn": "PrioriCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updatePrioricode": "PrioriCode-ni yangilang",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode {{distro}} da tayyor.",
  "wsl.onboarding.prioricodeReady": "PrioriCode tayyor.",
  "wsl.onboarding.installPrioricodeIn": "PrioriCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installPrioricode": "PrioriCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PrioriCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra PrioriCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida PrioriCode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (prioricode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, PrioriCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "PrioriCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi PrioriCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "PrioriCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "PrioriCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "PrioriCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "PrioriCode mavzusini sozlash.",
  ...
  "settings.updates.toast.latest.description": "Siz PrioriCode oxirgi versiyasini ishga tushiryapsiz.",
