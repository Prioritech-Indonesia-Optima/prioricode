...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "PrioriCode įkelti nepavyko",
  "PrioriCode langas netikėtai užsidarė",
  "PrioriCode neatsako",
  ...
  "PrioriCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "prioricode šiame distributyve neįdiegtas",
  "prioricode įdiegtas, bet jo paleisti nepavyko",
  "PrioriCode neįdiegtas distributyve {{distro}}",
  "PrioriCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.prioricode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.prioricode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.prioricodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami PrioriCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Aplankykite",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius PrioriCode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti prioricode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio PrioriCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingPrioricode": "Tikrinama PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Tikrinama PrioriCode {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Atnaujinamas PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Atnaujinamas PrioriCode {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Atnaujinkite PrioriCode {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Atnaujinkite PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode yra paruoštas {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode yra paruoštas.",
  "wsl.onboarding.installPrioricodeIn": "Įdiekite PrioriCode į {{distro}}.",
  "wsl.onboarding.installPrioricode": "Įdiekite PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad PrioriCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują PrioriCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą PrioriCode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (prioricode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad PrioriCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "PrioriCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "PrioriCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite PrioriCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite PrioriCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip PrioriCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar PrioriCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite PrioriCode temą.",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią PrioriCode versiją.",
