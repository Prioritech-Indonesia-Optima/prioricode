...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode yüklenemedi",
  "desktop.recovery.terminated": "PrioriCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "PrioriCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.prioricodeMissing": "prioricode bu dağıtımda kurulu değil",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "PrioriCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.prioricode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.prioricodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve PrioriCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.prioricodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak PrioriCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak PrioriCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler prioricode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi PrioriCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingPrioricode": "PrioriCode kontrol ediliyor...",
  "wsl.onboarding.checkingPrioricodeIn": "{{distro}} içinde PrioriCode kontrol ediliyor...",
  "wsl.onboarding.updatingPrioricode": "PrioriCode güncelleniyor...",
  "wsl.onboarding.updatingPrioricodeIn": "{{distro}} içinde PrioriCode güncelleniyor...",
  "wsl.onboarding.updatePrioricodeIn": "{{distro}} içindeki PrioriCode'u güncelleyin.",
  "wsl.onboarding.updatePrioricode": "PrioriCode'u güncelle",
  "wsl.onboarding.prioricodeReadyIn": "{{distro}} içinde PrioriCode hazır.",
  "wsl.onboarding.prioricodeReady": "PrioriCode hazır.",
  "wsl.onboarding.installPrioricodeIn": "PrioriCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installPrioricode": "PrioriCode'u kur",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PrioriCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından PrioriCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı PrioriCode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (prioricode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: PrioriCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "PrioriCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "PrioriCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "PrioriCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "PrioriCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "PrioriCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "PrioriCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "PrioriCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "PrioriCode'un en son sürümünü kullanıyorsunuz.",
