...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode 載入失敗",
  "desktop.recovery.terminated": "PrioriCode 視窗意外終止",
  "desktop.recovery.unresponsive": "PrioriCode 沒有回應",
  ...
  "desktop.wsl.error.installPrioricode": "PrioriCode 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.prioricodeMissing": "此發行版中未安裝 prioricode",
  "desktop.wsl.error.prioricodeCannotRun": "已安裝 prioricode，但無法執行",
  "desktop.wsl.error.prioricodeNotInstalled": "{{distro}} 中未安裝 PrioriCode",
  "desktop.wsl.error.updateVersion":
    "PrioriCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.prioricode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.prioricode.tagline": "經過最佳化的可靠模型",
  "dialog.provider.prioricodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "PrioriCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 PrioriCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.prioricodeZen.line1": "PrioriCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.prioricodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.prioricodeZen.visit.prefix": "造訪 ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 PrioriCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 PrioriCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 prioricode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 PrioriCode 伺服器。",
  ...
  "wsl.onboarding.checkingPrioricode": "正在檢查 PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "正在檢查 {{distro}} 中的 PrioriCode...",
  ...
  "wsl.onboarding.prioricodeReadyIn": "{{distro}} 中的 PrioriCode 已就緒。",
  "wsl.onboarding.prioricodeReady": "PrioriCode 已就緒。",
  "wsl.onboarding.installPrioricodeIn": "在 {{distro}} 中安裝 PrioriCode。",
  "wsl.onboarding.installPrioricode": "安裝 PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "未安裝 PrioriCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "PrioriCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 PrioriCode。",
  ...
  "help.tabs.introduction": "PrioriCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "PrioriCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 PrioriCode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (prioricode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：PrioriCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "PrioriCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 PrioriCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 PrioriCode 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 PrioriCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 PrioriCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 PrioriCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 PrioriCode 啟動時自動檢查更新",
