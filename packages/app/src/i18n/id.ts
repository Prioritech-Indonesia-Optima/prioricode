export const dict = {
  ...
  "desktop.recovery.loadFailed": "PrioriCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela PrioriCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "PrioriCode tidak merespons",
  ...
  "desktop.wsl.error.installPrioricode": "Instalasi PrioriCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.prioricodeMissing": "prioricode belum terinstal di distro ini",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan PrioriCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.prioricode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.prioricodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di PrioriCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di prioricode.json",
  ...
  "dialog.server.description": "Ganti server PrioriCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingPrioricode": "Memeriksa PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Memeriksa PrioriCode di {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Memperbarui PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Memperbarui PrioriCode di {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Perbarui PrioriCode di {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Perbarui PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode siap di {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode siap.",
  "wsl.onboarding.installPrioricodeIn": "Instal PrioriCode di {{distro}}.",
  "wsl.onboarding.installPrioricode": "Instal PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum PrioriCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru PrioriCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim PrioriCode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (prioricode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: PrioriCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server PrioriCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk PrioriCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan PrioriCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah PrioriCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat PrioriCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru PrioriCode.",
