export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'PrioriCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'PrioriCode",
  "desktop.recovery.terminated": "La fenêtre PrioriCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "PrioriCode ne répond pas",
  ...
  "desktop.wsl.error.installPrioricode": "Échec de l'installation d'PrioriCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.prioricodeMissing": "prioricode n'est pas installé dans cette distribution",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'PrioriCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.prioricode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.prioricodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Visitez ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans PrioriCode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans prioricode.json",
  ...
  "dialog.server.description": "Changez le serveur PrioriCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingPrioricode": "Vérification d'PrioriCode...",
  "wsl.onboarding.checkingPrioricodeIn": "Vérification d'PrioriCode dans {{distro}}...",
  "wsl.onboarding.updatingPrioricode": "Mise à jour d'PrioriCode...",
  "wsl.onboarding.updatingPrioricodeIn": "Mise à jour d'PrioriCode dans {{distro}}...",
  "wsl.onboarding.updatePrioricodeIn": "Mettez à jour PrioriCode dans {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Mettre à jour PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode est prêt dans {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode est prêt.",
  "wsl.onboarding.installPrioricodeIn": "Installez PrioriCode dans {{distro}}.",
  "wsl.onboarding.installPrioricode": "Installer PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'PrioriCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'PrioriCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe PrioriCode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (prioricode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'PrioriCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "PrioriCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur PrioriCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour PrioriCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'PrioriCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si PrioriCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'PrioriCode.",
