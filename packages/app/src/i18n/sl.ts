export const dict = {
  ...
  "desktop.menu.documentation": "PrioriCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "PrioriCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno PrioriCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "PrioriCode se ne odziva",
  ...
  "desktop.wsl.error.installPrioricode": "Namestitev PrioriCode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.prioricodeMissing": "prioricode ni nameščen v tej distribuciji",
  "desktop.wsl.error.prioricodeCannotRun": "prioricode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.prioricodeNotInstalled": "PrioriCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev PrioriCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.prioricode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.prioricode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.prioricodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja PrioriCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v PrioriCode.",
  ...
  "provider.connect.prioricodeZen.line1":
    "PrioriCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.prioricodeZen.visit.prefix": "Obisk ",
  "provider.connect.prioricodeZen.visit.link": "prioricode.ai/zen",
  "provider.connect.prioricodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v PrioriCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v PrioriCode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v prioricode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom PrioriCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingPrioricode": "Preverjanje PrioriCode ...",
  "wsl.onboarding.checkingPrioricodeIn": "Preverjanje PrioriCode v {{distro}} ...",
  "wsl.onboarding.updatingPrioricode": "Posodabljanje PrioriCode ...",
  "wsl.onboarding.updatingPrioricodeIn": "Posodabljanje PrioriCode v {{distro}} ...",
  "wsl.onboarding.updatePrioricodeIn": "Posodobite PrioriCode v {{distro}}.",
  "wsl.onboarding.updatePrioricode": "Posodobite PrioriCode",
  "wsl.onboarding.prioricodeReadyIn": "PrioriCode je pripravljen v {{distro}}.",
  "wsl.onboarding.prioricodeReady": "PrioriCode je pripravljen.",
  "wsl.onboarding.installPrioricodeIn": "Namestite PrioriCode v {{distro}}.",
  "wsl.onboarding.installPrioricode": "Namestite PrioriCode",
  ...
  "wsl.onboarding.distroStatus.prioricodeMissing": "PrioriCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko PrioriCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "PrioriCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite PrioriCode.",
  ...
  "help.tabs.introduction": "PrioriCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica PrioriCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi PrioriCode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (prioricode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, PrioriCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "PrioriCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik PrioriCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za PrioriCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako PrioriCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali PrioriCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo PrioriCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene PrioriCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico PrioriCode.",
