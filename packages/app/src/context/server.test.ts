  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://prioricode.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://prioricode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://prioricode.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://prioricode.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://prioricode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://prioricode.example.com"),
      ),
    ).toEqual({
