import type { PrioriCodeEvent } from "@prioricode/client/promise"
import type { Event } from "@prioricode/sdk/v2/client"
...
export type ServerEvent = Event & { current?: PrioriCodeEvent }
...
export function adaptServerEvent(event: PrioriCodeEvent): ServerEvent {
...
function currentDelta(event: PrioriCodeEvent | undefined): CurrentDelta | undefined {
  if (
