import type { PrioriCodeEvent, SessionMessageInfo, SessionPendingMessage } from "@prioricode/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: PrioriCodeEvent): V2SessionReduction | undefined => {
