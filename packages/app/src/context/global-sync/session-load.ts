import type { SessionApi } from "@prioricode/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { PrioricodeClient } from "@prioricode/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: PrioricodeClient; directory: string; limit: number }) {
  try {
