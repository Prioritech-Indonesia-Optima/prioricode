...
const GLOBAL_STORAGE = "prioricode.global.dat"
const WINDOW_STORAGE = "prioricode.window"
const LOCAL_PREFIX = "prioricode."
...
function workspaceStorage(dir: string) {
  ...
  return `prioricode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `prioricode.draft.${head}.${sum}.dat`
}
