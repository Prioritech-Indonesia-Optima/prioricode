...
import { Dialog, DialogBody } from "@prioricode/ui/v2/dialog-v2"
          ...
          <div class="command-palette-v2-row-main">
            <div class="relative shrink-0">
              <Show when={props.sessionOpen}>
                <span
                  aria-hidden="true"
                  class="pointer-events-none absolute top-1/2 h-3 w-0.5 -translate-y-1/2 rounded-[2px] bg-pc-bg-layer-04"
