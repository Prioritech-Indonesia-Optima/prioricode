...
import { Switch } from "@prioricode/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://prioricode.ai/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_PRIORICODE_CHANNEL !== "prod"}>
          <SettingsRowV2
