...
beforeAll(async () => {
  ...
  mock.module("@prioricode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@prioricode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@prioricode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@prioricode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
