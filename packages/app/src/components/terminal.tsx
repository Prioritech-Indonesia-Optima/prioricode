import { withAlpha } from "@prioricode/ui/theme/color"
import { useTheme } from "@prioricode/ui/theme/context"
import { resolveThemeVariant } from "@prioricode/ui/theme/resolve"
import { resolveThemeVariantV2 } from "@prioricode/ui/theme/v2/resolve"
import type { HexColor, ResolvedV2Theme } from "@prioricode/ui/theme/types"
...
export const Terminal = (props: TerminalProps) => {
  ...
  const username = auth?.username ?? "prioricode"
  ...
  const getTerminalColors = (): TerminalColors => {
    ...
    const background = settings.general.newLayoutDesigns()
      ? (resolveV2Token(resolveThemeVariantV2(variant, mode === "dark"), "pc-bg-base") ?? fallback.background)
