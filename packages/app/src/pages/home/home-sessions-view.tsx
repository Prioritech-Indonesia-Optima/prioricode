...
const HOME_SECTION_LABEL = "text-pc-text-muted [font-weight:440]"
...
export function HomeSessionsView(props: HomeSessionsViewProps) {
  return (
    ...
    >
      <div class="sticky top-0 z-30 shrink-0 bg-pc-bg-base pb-3 pt-6 lg:pt-12" onWheel={props.onWheel}>
      ...
      <div ref={props.onSetSearchRoot} data-component="home-session-search" class="relative z-30 w-full">
        <Show when={props.searchOpen()}>
          <div
            ...
            class={`
              ...
              bg-pc-bg-base shadow-[var(--pc-elevation-floating)]
            `}
            ...
            <div class="flex flex-col pt-9">
              <div id={HOME_SESSION_SEARCH_RESULTS_ID} role="listbox" class="flex flex-col gap-4 pt-4">
                <Show
                  ...
                  fallback={
                    <div class="flex items-center justify-center px-4 py-3 text-pc-text-muted [font-weight:440]">
        ...
        <label
          class={`
            ...
            bg-pc-bg-layer-02/60 text-pc-icon-muted transition-[background-color,box-shadow]
            duration-[120ms] ease-in-out hover:bg-pc-bg-layer-02 focus-within:bg-pc-bg-layer-02
          `}
        >
          ...
          <input
            ...
            class={`
              ...
              text-pc-text-base [font-weight:440] placeholder:text-pc-text-faint
            `}
  ...
  return (
    <button
      ...
      class={`
        ...
        hover:bg-pc-overlay-hover focus-visible:bg-pc-overlay-hover focus-visible:outline-none
      `}
      classList={{
        "bg-pc-overlay-hover": props.selected,
  ...
  return (
    <div
      ...
      class={`
        ...
        bg-pc-bg-base pl-3 lg:top-[108px]
      `}
    ...
    >
      <button
        ...
        class={`
          ...
          bg-transparent py-3 pl-3 pr-10 text-left text-pc-text-muted [font-weight:530]
...
function HomeSessionTitle(props: { title: string; showProjectName: boolean; search?: boolean }) {
  return (
    <span
      class="min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-pc-text-base [font-weight:530]"
      classList={{
...
function HomeSessionProjectName(props: { name: string; search?: boolean }) {
  return (
    <span
      class="min-w-0 flex-[1_1_auto] overflow-hidden text-ellipsis whitespace-nowrap text-pc-text-muted [font-weight:440]"
  ...
  return (
    <div class="flex min-w-0 flex-col gap-4">
      ...
      <div class="flex min-w-0 flex-col gap-px" aria-hidden="true">
        <For each={[0, 1, 2, 3]}>{() => <div class="h-10 rounded-[6px] bg-pc-bg-deep opacity-70" />}</For>
      </div>
    </div>
  )
}
