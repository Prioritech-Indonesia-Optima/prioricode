...
import { Session } from "@prioricode/sdk/v2/client"
...
import { retry } from "@prioricode/core/util/retry"
...
import { useTheme, type ColorScheme } from "@prioricode/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://prioricode.ai/desktop-feedback")}
      renderPanel={() =>
