import type { Todo } from "@prioricode/sdk/v2"
import { AnimatedNumber } from "@prioricode/ui/animated-number"
import { Checkbox } from "@prioricode/ui/checkbox"
import { DockTray } from "@prioricode/ui/dock-surface"
...
import { TextStrikethrough } from "@prioricode/ui/text-strikethrough"
...
export function SessionTodoDock(props: {
  ...
  return (
    <Dynamic
      ...
      classList={{
        "w-full overflow-hidden rounded-xl border-[0.5px] border-pc-border-base bg-pc-bg-layer-01":
        ...
        >
          <span
            classList={{
              ...
              "font-[440] text-[13px] leading-5 tracking-[-0.04px] text-pc-text-muted":
                settings.general.newLayoutDesigns(),
          ...
          >
            <TextReveal
              class={
                settings.general.newLayoutDesigns()
                  ? "cursor-default text-[13px] font-[440] leading-5 tracking-[-0.04px] text-pc-text-faint"
