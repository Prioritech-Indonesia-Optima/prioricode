import type { Hooks, PluginInput } from "@prioricode/plugin"
import type { Model } from "@prioricode/sdk/v2"
import { InstallationVersion } from "@prioricode/core/installation/version"
import { OauthCallbackPage } from "@prioricode/core/oauth/page"
...
async function listRouters(
  ...
  const res = await fetch(`${DO_GENAI_API}/models/routers`, {
    headers: {
      ...
      "User-Agent": `prioricode/${InstallationVersion}`,
    },
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. PrioriCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
