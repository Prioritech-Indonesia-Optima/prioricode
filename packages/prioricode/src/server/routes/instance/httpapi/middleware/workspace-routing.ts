...
>()("@prioricode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@prioricode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.PRIORICODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.PRIORICODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-prioricode-directory"] || process.cwd()
}
