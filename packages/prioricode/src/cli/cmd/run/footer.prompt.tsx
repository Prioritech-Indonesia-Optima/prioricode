...
import { normalizePromptContent } from "@prioricode/tui/editor"
...
import { PRIORICODE_BASE_MODE, useBindings } from "@prioricode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close PrioriCode" } satisfies SlashOption,
    ]
