...
import { openEditor } from "@prioricode/tui/editor"
import { registerPrioricodeKeymap } from "@prioricode/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerPrioricodeKeymap(keymap, renderer, input.tuiConfig)
