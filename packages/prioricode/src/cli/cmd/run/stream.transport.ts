...
import type { Event, GlobalEvent, PrioricodeClient } from "@prioricode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@prioricode/RunStreamTransport") {}
