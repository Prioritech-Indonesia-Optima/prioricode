...
//
// The saved variant persists across sessions in ~/.local/state/prioricode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@prioricode/RunVariant") {}
