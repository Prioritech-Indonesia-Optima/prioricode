...
import { AccountStateTable, AccountTable } from "@prioricode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/AccountRepo") {}
