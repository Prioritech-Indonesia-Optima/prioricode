...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@prioricode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@prioricode/ACPDirectory") {}
