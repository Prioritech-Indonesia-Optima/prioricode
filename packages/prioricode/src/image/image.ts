...
export class Service extends Context.Service<Service, Interface>()("@prioricode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __PRIORICODE_PHOTON_WASM_PATH?: string }).__PRIORICODE_PHOTON_WASM_PATH =
