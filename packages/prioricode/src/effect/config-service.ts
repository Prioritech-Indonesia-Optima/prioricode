 ...
 *   "@prioricode/ServerAuthConfig",
 *   {
 *     password: Config.string("PRIORICODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("PRIORICODE_SERVER_USERNAME").pipe(Config.withDefault("prioricode")),
 *   },
 * ) {}
 *
