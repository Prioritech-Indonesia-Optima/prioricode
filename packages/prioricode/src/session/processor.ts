...
import { Usage, type LLMEvent } from "@prioricode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "tool-call": {
            ...
            const mode = yield* session
              .get(ctx.assistantMessage.sessionID)
              .pipe(
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean prioricode changed history behind a signed
