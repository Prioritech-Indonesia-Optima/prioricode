...
import type { ProviderMetadata, Usage } from "@prioricode/llm"
...
import { locationServiceMapLayer } from "@prioricode/core/location-services"
...
import { PartTable, SessionTable } from "@prioricode/core/session/sql"
...
import { NonNegativeInt, optional } from "@prioricode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".prioricode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/Session") {}
