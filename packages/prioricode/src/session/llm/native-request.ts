import type { JsonSchema, LLMRequest, ProviderMetadata } from "@prioricode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@prioricode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @prioricode/llm request objects from prioricode's session/AI SDK-shaped data.
  return LLM.request({
