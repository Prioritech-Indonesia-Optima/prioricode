import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@prioricode/llm"
...
// Move this extraction into @prioricode/llm when Copilot is handled by the native runtime.
