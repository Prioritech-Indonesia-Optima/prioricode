...
import { llmClient } from "@prioricode/core/effect/app-node-platform"
...
import { LLMClient } from "@prioricode/llm/route"
import type { LLMClientService } from "@prioricode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via prioricode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @prioricode/llm. It
