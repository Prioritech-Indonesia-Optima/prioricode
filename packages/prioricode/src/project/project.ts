...
import { ProjectDirectoryTable, ProjectTable } from "@prioricode/core/project/sql"
import { ProjectDirectories } from "@prioricode/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.PRIORICODE_FAKE_VCS)
