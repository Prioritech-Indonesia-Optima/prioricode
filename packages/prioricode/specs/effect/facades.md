...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/prioricode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy prioricode service removed
