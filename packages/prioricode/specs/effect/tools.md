...
Practical reference for the current tool-migration state in `packages/prioricode`.
...
Tool tests should use the existing Effect helpers in `packages/prioricode/test/lib/effect.ts`:
