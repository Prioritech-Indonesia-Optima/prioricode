...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips prioricode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-prioricode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-prioricode-directory")).toBeNull()
      expect(result.get("x-prioricode-workspace")).toBeNull()
