...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips prioricode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-prioricode-directory"]).toBeUndefined()
      expect(forwarded["x-prioricode-workspace"]).toBeUndefined()
