...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PRIORICODE_CALLER", () => {
    process.env["PRIORICODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PRIORICODE_CALLER", () => {
    process.env["PRIORICODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PRIORICODE_CALLER", () => {
    process.env["PRIORICODE_CALLER"] = "unknown"
