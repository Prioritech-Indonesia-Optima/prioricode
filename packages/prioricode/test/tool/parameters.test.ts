...
import { Parameters as Jobs } from "../../src/tool/jobs"
...
describe("tool parameters", () => {
  describe("JSON Schema (wire shape)", () => {
    ...
    test("jobs", () => expect(toJsonSchema(Jobs)).toMatchSnapshot())
  ...
  describe("websearch", () => {
    test("accepts query", () => {
      expect(parse(WebSearch, { query: "prioricode" }).query).toBe("prioricode")
    })
  })
