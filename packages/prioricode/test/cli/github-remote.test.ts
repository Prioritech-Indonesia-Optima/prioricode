...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/prioricode.git")).toEqual({ owner: "sst", repo: "prioricode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/prioricode")).toEqual({ owner: "sst", repo: "prioricode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/prioricode.git")).toEqual({ owner: "sst", repo: "prioricode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/prioricode")).toEqual({ owner: "sst", repo: "prioricode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/prioricode.git")).toEqual({ owner: "sst", repo: "prioricode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/prioricode")).toEqual({ owner: "sst", repo: "prioricode" })
})
