...
import { registerPrioriCodeTheme } from "@prioricode/ui/context/marked-theme-register"

registerPrioriCodeTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for PrioriCode, as I think 8 might be
