...
import type { Definition } from "@prioricode/schema/event"
...
export const PrioriCodeEvent = event.schema
export type PrioriCodeEvent = typeof PrioriCodeEvent.Type
export type PrioriCodeEventEncoded = typeof PrioriCodeEvent.Encoded
