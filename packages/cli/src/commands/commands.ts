...
declare const PRIORICODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof PRIORICODE_CLI_NAME === "string" ? PRIORICODE_CLI_NAME : "prioricode", {
  description: "PrioriCode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
