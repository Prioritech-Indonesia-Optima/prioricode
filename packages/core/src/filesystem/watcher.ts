...
import { FileSystemWatcher } from "@prioricode/schema/filesystem-watcher"
...
declare const PRIORICODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof PRIORICODE_LIBC === "undefined" ? undefined : PRIORICODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.PRIORICODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.PRIORICODE_EXPERIMENTAL_FILEWATCHER)) {
