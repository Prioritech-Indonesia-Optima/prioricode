...
import { Entry, FileSystem, FindInput, Match } from "@prioricode/schema/filesystem"
export { Entry, Match, Submatch } from "@prioricode/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/v2/FileSystem") {}
