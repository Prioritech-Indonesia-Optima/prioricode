...
import type { Data, Definition, Payload } from "@prioricode/schema/event"
...
import { Durable } from "@prioricode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@prioricode/schema/event").ID
export type { Data, Definition, Payload } from "@prioricode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/Event") {}
