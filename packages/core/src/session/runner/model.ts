...
import { type Model } from "@prioricode/llm"
import * as AnthropicMessages from "@prioricode/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@prioricode/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@prioricode/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@prioricode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/v2/SessionRunnerModel") {}
