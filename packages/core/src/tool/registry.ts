...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@prioricode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/v2/ToolRegistry") {}
