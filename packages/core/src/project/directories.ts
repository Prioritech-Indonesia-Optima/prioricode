...
import type { EffectDrizzleSqlite } from "@prioricode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/ProjectDirectories") {}
