...
import { Event } from "@prioricode/schema/project-directories"
import { ProjectCopy } from "@prioricode/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/ProjectCopy") {}
