...
import { ListAnchor } from "@prioricode/schema/session"
...
import { SessionDurable } from "@prioricode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/v2/Session") {}
