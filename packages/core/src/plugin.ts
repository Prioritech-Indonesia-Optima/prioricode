...
import type { Plugin as PluginRuntime } from "@prioricode/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@prioricode/v2/Plugin") {}
