...
import { compile, emitEffectImported, emitPromise, write } from "@prioricode/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "PrioriCodeEventEncoded",
              import: 'import type { PrioriCodeEventEncoded } from "@prioricode/protocol/groups/event"',
            },
          },
        }),
