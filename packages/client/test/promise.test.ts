...
import { isSessionNotFoundError, isUnauthorizedError, PrioriCode } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = PrioriCode.make({ baseUrl: "http://localhost:3000" })
