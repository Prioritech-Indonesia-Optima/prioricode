...
export const TypeId: TypeId = "~@prioricode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@prioricode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@prioricode/effect-sqlite-node/NodeSqliteClient")
