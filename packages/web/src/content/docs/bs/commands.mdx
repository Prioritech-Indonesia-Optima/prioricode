...
Kreiraj `.prioricode/commands/test.md`:
...
Možete dodati prilagođene komande kroz PrioriCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom PrioriCode [config](/docs/config):
...
- Globalno: `~/.config/prioricode/commands/`
- Po projektu: `.prioricode/commands/`
...
PrioriCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
