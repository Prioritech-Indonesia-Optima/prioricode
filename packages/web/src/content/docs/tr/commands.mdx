...
`.prioricode/commands/test.md` oluştur:
...
prioricode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

prioricode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/prioricode/commands/`
- Proje başına: `.prioricode/commands/`
...
prioricode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
