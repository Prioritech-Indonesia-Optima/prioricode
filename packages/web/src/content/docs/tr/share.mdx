---
title: Paylasim
description: prioricode konusmalarini genel baglantilarla paylasin.
---

prioricode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda prioricode:
...
prioricode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak prioricode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `prioricode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda prioricode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
