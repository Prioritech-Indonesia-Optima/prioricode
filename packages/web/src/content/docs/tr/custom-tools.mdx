---
title: Özel Araçlar
description: LLM'un prioricode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. prioricode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.prioricode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/prioricode/tools/` içine yerleştirerek.
