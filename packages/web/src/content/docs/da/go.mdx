...
PrioriCode Go er et lavprisabonnement til **$10/måned**, der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i PrioriCode. Du abonnerer på PrioriCode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med PrioriCode.
:::
...
PrioriCode Go giver dig adgang til disse modeller for **$10/måned**.

---

## Sådan fungerer det

PrioriCode Go fungerer som enhver anden udbyder i PrioriCode.

1. Du logger ind på **<a href={console}>PrioriCode Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `PrioriCode Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på PrioriCode Go.
:::
...
PrioriCode Go er udviklet til [PrioriCode](https://prioricode.ai) og andre kodningsagenter,
...
3. Sende et stabilt sessions-id i `x-prioricode-session` for hver samtale, så vi kan optimere routing og
   prompt-caching.

### Validerede klienter

Ud over PrioriCode er følgende klienter blevet valideret til at fungere korrekt
med PrioriCode Go. Vi garanterer dog ikke, at de fortsat vil fungere fremover.

| Klient            | Sessionsunderstøttelse                                                                                                                                                                                                                                    |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Builds, der indeholder [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864), sender headeren i primære og sekundære PrioriCode-anmodninger. Rettelsen blev merged efter v0.21.0; den version indeholder den ikke i sig selv.              |
...
| **ZCode**         | Go genkender dens indbyggede sessionsheader. Vores [anmodning om `x-prioricode-session`](https://github.com/zai-org/feedback/issues/492) er stadig åben, men det er ikke længere nødvendigt at sende netop denne header.                                    |
| **Pi**            | Aktuelle builds sender sessionsoplysninger til PrioriCode. Opdater ældre installationer.                                                                                                                                                                    |
...
| **Kilo Code CLI** | Builds, der indeholder [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752), gendanner PrioriCode-sessionsheadere. Denne rettelse dækker CLI'en, men ikke VS Code-udvidelsen. Se [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
Dit [model id](/docs/config/#models) i din PrioriCode config
bruger formatet `prioricode-go/<model-id>`. For eksempel for Kimi K3, vil du
bruge `prioricode-go/kimi-k3` i din config.
...
Vi skabte PrioriCode Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med PrioriCode.
