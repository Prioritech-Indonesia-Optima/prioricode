...
Brug den til at bygge integrasjoner og kontrollere prioricode programmatisk.
...
Opret en forekomst av prioricode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `prioricode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av prioricode, kan du oprete en klientforekomst for at koble til den:
