...
description: Opret værktøjer, som LLM kan kalde prioricode ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med prioricodes [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.prioricode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/prioricode/tools/`.
