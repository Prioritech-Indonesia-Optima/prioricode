---
title: TUI
description: Brug af PrioriCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PrioriCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre PrioriCode starter TUI for den nuværende mappe.
...
Når du bruger PrioriCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til PrioriCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut PrioriCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `prioricode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe PrioriCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `prioricode.default`.
