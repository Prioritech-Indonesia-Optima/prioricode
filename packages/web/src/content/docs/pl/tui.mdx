---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala prioricode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

prioricode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie prioricode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI prioricode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do prioricode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij prioricode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `prioricode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo PrioriCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `prioricode.default`.
