...
Utwórz `.prioricode/commands/test.md`:
...
Możesz zdefiniować polecenia w `prioricode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji prioricode:
...
- Globalnie: `~/.config/prioricode/commands/`
- Na projekt: `.prioricode/commands/`
...
prioricode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
