...
สร้าง `.prioricode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ PrioriCode:
...
- ระดับผู้ใช้ (Global): `~/.config/prioricode/commands/`
- ระดับโปรเจ็กต์: `.prioricode/commands/`
...
PrioriCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
