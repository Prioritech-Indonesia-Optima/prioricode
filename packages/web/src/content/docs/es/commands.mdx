...
Crear `.prioricode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración PrioriCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su PrioriCode [config](/docs/config):
...
- Por proyecto: `.prioricode/commands/`
...
prioricode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
