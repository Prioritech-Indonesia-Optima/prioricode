---
title: IDE
description: The PrioriCode extension for VS Code, Cursor, and other IDEs
---

PrioriCode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `prioricode` in the terminal to get started.
...
To install PrioriCode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `prioricode` - the extension installs automatically
...
Search for **PrioriCode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `prioricode` in the integrated terminal.
