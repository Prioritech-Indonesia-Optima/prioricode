...
Crea `.prioricode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di PrioriCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di PrioriCode:
...
- Globale: `~/.config/prioricode/commands/`
- Per progetto: `.prioricode/commands/`
...
prioricode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
