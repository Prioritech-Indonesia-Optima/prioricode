...
Opprett `.prioricode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom PrioriCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i PrioriCode [config](/docs/config):
...
- Per prosjekt: `.prioricode/commands/`
...
PrioriCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
