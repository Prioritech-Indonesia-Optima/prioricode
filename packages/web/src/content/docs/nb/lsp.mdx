---
title: LSP-servere
description: prioricode integreres med LSP-serverne dine.
---

PrioriCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

PrioriCode kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `PRIORICODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og prioricode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i PrioriCode-konfigurasjonen.
