...
Agentferdigheter lar PrioriCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går prioricode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
prioricode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `prioricode.json`:
