...
Erstellen Sie `.prioricode/commands/test.md`:

```md title=".prioricode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die PrioriCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem PrioriCode [config](/docs/config):

```json title="prioricode.jsonc" {4-12}
{
...
- Global: `~/.config/prioricode/commands/`
- Pro Projekt: `.prioricode/commands/`

```markdown title="~/.config/prioricode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".prioricode/commands/component.md"
---
...
```md title=".prioricode/commands/create-file.md"
---
...
```md title=".prioricode/commands/analyze-coverage.md"
---
...
```md title=".prioricode/commands/review-changes.md"
---
...
```md title=".prioricode/commands/review-component.md"
---
...
PrioriCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
