---
title: SDK
description: Typsicherer JS-Client fuer den prioricode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das prioricode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und prioricode programmatisch steuern.
...
Erstelle eine prioricode-Instanz:
...
`prioricode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn prioricode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
