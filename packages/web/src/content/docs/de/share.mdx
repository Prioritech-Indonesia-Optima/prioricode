---
title: Teilen
description: Teile PrioriCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu PrioriCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht PrioriCode Folgendes:
...
PrioriCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt PrioriCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`prioricode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du prioricode in deiner Organisation einsetzt.
