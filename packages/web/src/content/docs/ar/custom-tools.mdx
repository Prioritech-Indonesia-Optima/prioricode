...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في prioricode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في prioricode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.prioricode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/prioricode/tools/`.
