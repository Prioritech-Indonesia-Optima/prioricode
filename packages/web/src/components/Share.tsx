...
import { IconPrioricode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "prioricode/session/message-v2"
import type { Message } from "prioricode/session/message"
import type { Session } from "prioricode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.prioricode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.prioricode_name}>
                    <IconPrioricode width={16} height={16} />
                  </div>
