...
import compareVideo from "../../asset/lander/prioricode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/prioricode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="prioricode:auth" content={loggedin() ? "true" : "false"} />
