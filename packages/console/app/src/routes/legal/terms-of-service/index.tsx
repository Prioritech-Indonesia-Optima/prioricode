...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>PrioriCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="PrioriCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to PrioriCode. Please read on to learn the rules and restrictions that govern your use of
                PrioriCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <h2 id="what-is-prioricode">What is PrioriCode?</h2>
              <p>
                PrioriCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the PrioriCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, PrioriCode enables you to
              ...
              <p>
                ...
                our site located at prioricode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using PrioriCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by PrioriCode;
                </li>
                <li>
              ...
              <p>
                If you use PrioriCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                PrioriCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                PrioriCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-prioricode-ever-change-the-services">Will PrioriCode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://prioricode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://prioricode.ai/auth">https://prioricode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                PRIORICODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO PRIORICODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the PrioriCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without PrioriCode's prior written
              ...
              <p>
                Either you or PrioriCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                agreement permits either you or PrioriCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and PrioriCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the PrioriCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
