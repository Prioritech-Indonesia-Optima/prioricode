      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://prioricode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>prioricode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g prioricode-ai")}>
                <code>
                  npm i -g <strong>prioricode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g prioricode-ai")}>
                <code>
                  bun add -g <strong>prioricode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/prioricode")}>
                <code>
                  brew install <strong>anomalyco/tap/prioricode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S prioricode")}>
                <code>
                  paru -S <strong>prioricode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask prioricode-desktop")}>
                <code>
                  brew install --cask <strong>prioricode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
