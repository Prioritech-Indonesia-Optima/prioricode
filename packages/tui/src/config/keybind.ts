...
export const Definitions = {
  ...
  model_config_edit: keybind("ctrl+s", "Edit settings for the selected model"),
...
export const CommandMap = {
  ...
  status_view: "prioricode.status",
  debug_view: "prioricode.debug",
  ...
  model_config_edit: "model.dialog.settings",
