...
import defaultSoundPath from "@prioricode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@prioricode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@prioricode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@prioricode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@prioricode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@prioricode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "prioricode"
const DEFAULT_PACK_ID = "prioricode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "PrioriCode Default",
  builtin: true,
  sounds: {
