...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@prioricode/sdk/v2"
...
const CUSTOM_PROVIDER_OPTION_VALUE = "__prioricode_custom_provider__"
    ...
    ...pipe(
      ...
      map((provider) => ({
        ...
        description: {
          ...
          "prioricode-go": "Low cost subscription for everyone",
        }[provider.id],
      ...
      description={() =>
        ({
          prioricode: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                PrioriCode Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://prioricode.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "prioricode-go": (
