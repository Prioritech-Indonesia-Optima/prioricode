...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "PRIORICODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/prioricode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/prioricode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/prioricode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/prioricode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const PRIORICODE_DB|PRIORICODE_DB|PRIORICODE_DEV|Global\\.Path\\.data|data =" in packages/prioricode/src (115 matches)',
  },
] as const
