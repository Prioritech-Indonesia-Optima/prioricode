...
const releaseId = process.env.PRIORICODE_RELEASE
if (!releaseId) throw new Error("PRIORICODE_RELEASE is required")

const version = process.env.PRIORICODE_VERSION
if (!version) throw new Error("PRIORICODE_VERSION is required")
...
const macxTarGz = "prioricode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "prioricode-desktop-mac-arm64.app.tar.gz"
