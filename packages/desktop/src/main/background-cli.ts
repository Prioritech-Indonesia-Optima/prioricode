...
const desktopStateNames = ["ai.prioricode.desktop.dev", "ai.prioricode.desktop.beta", "ai.prioricode.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "prioricode-cli.exe" : "prioricode-cli"
}
