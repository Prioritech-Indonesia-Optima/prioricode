export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av PrioriCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av PrioriCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert i {{path}}\n\nStart terminalen på nytt for å bruke 'prioricode'-kommandoen.",
