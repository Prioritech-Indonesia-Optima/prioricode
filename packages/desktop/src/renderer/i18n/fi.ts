export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo PrioriCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää PrioriCoden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'prioricode'-komentoa.",
