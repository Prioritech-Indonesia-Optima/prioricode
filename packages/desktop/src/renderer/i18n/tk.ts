export const dict = {
  ...
  "desktop.updater.none.message": "PrioriCode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'prioricode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
