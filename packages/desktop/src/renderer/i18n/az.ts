export const dict = {
  ...
  "desktop.updater.none.message": "Artıq PrioriCode-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCode-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'prioricode' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
