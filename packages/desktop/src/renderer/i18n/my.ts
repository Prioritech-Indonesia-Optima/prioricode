export const dict = {
  ...
  "desktop.updater.none.message": "သင်သည် PrioriCode ၏နောက်ဆုံးထွက်ဗားရှင်းကို အသုံးပြုနေပြီဖြစ်သည်။",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCode ၏ {{version}} ဗားရှင်းကို ဒေါင်းလုဒ်လုပ်ပြီးပြီ၊ ၎င်းကို ထည့်သွင်းပြီး ပြန်လည်စတင်လိုပါသလား။",
  ...
  "desktop.cli.installed.message":
    "CLI ကို {{path}} တွင် ထည့်သွင်းထားသည်။\n\n'prioricode' ကွန်မန်းကို အသုံးပြုရန် Terminal ကို ပြန်လည်စတင်ပါ။",
