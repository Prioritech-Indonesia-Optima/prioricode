export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon PrioriCode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'prioricode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
