export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van PrioriCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van PrioriCode is gedownload. Wil je deze installeren en PrioriCode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'prioricode' te gebruiken.",
