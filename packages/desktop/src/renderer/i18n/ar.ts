export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من PrioriCode",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من PrioriCode. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
