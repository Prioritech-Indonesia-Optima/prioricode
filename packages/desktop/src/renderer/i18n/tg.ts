export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини PrioriCode-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз PrioriCode зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",
  ...
  "desktop.cli.installed.message":
    "CLI ба {{path}} насб карда шудааст\n\nБарои истифодаи фармони 'prioricode' терминали худро аз нав оғоз кунед.",
