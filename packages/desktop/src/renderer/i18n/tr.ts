export const dict = {
  ...
  "desktop.updater.none.message": "PrioriCode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'prioricode' komutunu kullanmak için terminalinizi yeniden başlatın.",
