export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse PrioriCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "PrioriCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „prioricode” kasutamiseks taaskäivitage terminal.",
