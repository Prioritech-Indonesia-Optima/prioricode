export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af PrioriCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af PrioriCode hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
  ...
  "desktop.cli.installed.message":
    "CLI sett upp í {{path}}\n\nEndurræstu skjáherminn til að nota 'prioricode' skipunina.",
