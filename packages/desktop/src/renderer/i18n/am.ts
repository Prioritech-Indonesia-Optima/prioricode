export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የPrioriCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከPrioriCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
