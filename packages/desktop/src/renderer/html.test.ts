...
/**
 * Packaged Electron windows load renderer HTML via the privileged `pc://`
...
describe("electron vite publicDir", () => {
  test("configured publicDir resolves to a directory with pc-theme-preload.js", async () => {
    ...
    expect(existsSync(join(resolved, "pc-theme-preload.js"))).toBe(true)
  })
})
