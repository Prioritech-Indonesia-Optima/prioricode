export const dict = {
  "app.title": "Ranking de uso de modelos de IA | PrioriCode Data",
  "app.description":
    "Explore o uso do PrioriCode em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do PrioriCode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao PrioriCode no GitHub",
  "header.github": "GitHub",
  "header.tryPrioriCode": "Experimente o PrioriCode",
  ...
  "footer.homeAria": "Início do PrioriCode",
  ...
  "modal.title": "Newsletter do PrioriCode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no PrioriCode.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do PrioriCode por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | PrioriCode Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no PrioriCode, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do PrioriCode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no PrioriCode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do PrioriCode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do PrioriCode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | PrioriCode Data",
  "model.description":
    "Veja dados de uso de {{model}} no PrioriCode, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no PrioriCode aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do PrioriCode da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do PrioriCode da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do PrioriCode na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do PrioriCode, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do PrioriCode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do PrioriCode na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do PrioriCode na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do PrioriCode.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do PrioriCode correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do PrioriCode.",
