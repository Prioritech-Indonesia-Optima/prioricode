export const dict = {
  "app.title": "Rankingi użycia modeli AI | PrioriCode Data",
  "app.description":
    "Przeglądaj użycie PrioriCode w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny PrioriCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę PrioriCode na GitHub",
  "header.github": "GitHub",
  "header.tryPrioriCode": "Wypróbuj PrioriCode",
  ...
  "footer.homeAria": "Strona główna PrioriCode",
  ...
  "home.topModelsDescription": "Użycie modeli w PrioriCode.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy PrioriCode według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | PrioriCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w PrioriCode, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia PrioriCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w PrioriCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia PrioriCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów PrioriCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | PrioriCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w PrioriCode, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie PrioriCode pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu PrioriCode z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu PrioriCode z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia PrioriCode w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny PrioriCode, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia PrioriCode.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów PrioriCode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy PrioriCode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji PrioriCode.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne PrioriCode nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów PrioriCode.",
