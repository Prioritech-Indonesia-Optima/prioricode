export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | PrioriCode Data",
  "app.description":
    "Esplora l'utilizzo di PrioriCode nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo PrioriCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a PrioriCode su GitHub",
  "header.github": "GitHub",
  "header.tryPrioriCode": "Prova PrioriCode",
  ...
  "footer.homeAria": "Home PrioriCode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in PrioriCode.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di PrioriCode per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | PrioriCode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in PrioriCode, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di PrioriCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in PrioriCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di PrioriCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token PrioriCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | PrioriCode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in PrioriCode, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di PrioriCode appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo PrioriCode della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo PrioriCode della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di PrioriCode nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di PrioriCode, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di PrioriCode.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token PrioriCode nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di PrioriCode nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione PrioriCode.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica PrioriCode corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token PrioriCode.",
