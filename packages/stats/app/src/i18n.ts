...
const en = {
  "app.title": "AI Model Usage Rankings | PrioriCode Data",
  "app.description":
    "Explore PrioriCode usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "PrioriCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star PrioriCode on GitHub",
  "header.github": "GitHub",
  "header.tryPrioriCode": "Try PrioriCode",
  ...
  "footer.homeAria": "PrioriCode home",
  ...
  "home.topModelsDescription": "Usage of models across PrioriCode.",
  ...
  "home.uniqueUsersDescription": "Daily unique PrioriCode users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | PrioriCode Data",
  "lab.description":
    "Compare {{lab}} models used in PrioriCode, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent PrioriCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in PrioriCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent PrioriCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | PrioriCode Data",
  "model.description":
    "View {{model}} PrioriCode usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. PrioriCode usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's PrioriCode usage",
  "model.ranked": "Ranked #{{rank}} across last week's PrioriCode usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No PrioriCode usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no PrioriCode usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No PrioriCode geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent PrioriCode token volume.",
