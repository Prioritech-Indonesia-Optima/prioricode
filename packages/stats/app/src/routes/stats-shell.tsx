import prioricodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const themeStorageKey = "prioricode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://prioricode.ai/">
            <strong>{i18n.t("header.tryPrioriCode")}</strong>
          </a>
          <button
...
function PrioriCodeMark() {
  return (
    <svg data-slot="prioricode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://prioricode.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://prioricode.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@prioricode.ai", label: i18n.t("footer.contact") },
    { href: "https://prioricode.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/prioricode", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://prioricode.ai" aria-label={i18n.t("footer.homeAria")}>
          <PrioriCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={prioricodeWordmarkDark} alt="PrioriCode" />
          <button
