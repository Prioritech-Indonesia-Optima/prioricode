...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new PrioricodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the PrioriCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the PrioriCode system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the PrioriCode server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local PrioriCode state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global PrioriCode configuration settings and preferences.
   */
   ...
   *
   * Update global PrioriCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the PrioriCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the PrioriCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all PrioriCode instances, releasing all resources.
   */
   ...
   * Upgrade prioricode
   *
   * Upgrade prioricode to the specified version.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current PrioriCode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update PrioriCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current PrioriCode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the PrioriCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with PrioriCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that PrioriCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by PrioriCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all PrioriCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific PrioriCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  /**
   * Get session coordination state
   *
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this PrioriCode process. Idle interruption is a no-op.
   */
...
export class PrioricodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<PrioricodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    PrioricodeClient.__registry.set(this, args?.key)
  }
