...
const themePath = import.meta.dir + "/../src/theme/themes/pc-2.json"
...
console.log("Updated pc-2.json v2Overrides", Object.keys(light).length, "tokens per mode")
...
function readTokens(mode: "light" | "dark") {
  ...
  if (!block) throw new Error(`Missing ${mode} PC-2 tokens`)
