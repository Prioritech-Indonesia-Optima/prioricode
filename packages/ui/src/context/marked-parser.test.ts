...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[PrioriCode](https://prioricode.ai)")).toBe(
    '<p><a href="https://prioricode.ai" class="external-link" target="_blank" rel="noopener noreferrer">PrioriCode</a></p>\n',
  )
})
