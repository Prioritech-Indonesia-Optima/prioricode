...
Το PrioriCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/Prioritech-Indonesia-Optima/prioricode/releases) ή το [prioricode.ai/download](https://prioricode.ai/download).
