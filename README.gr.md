...
nix run nixpkgs#prioricode           # ή github:anomalyco/prioricode με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το PrioriCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/anomalyco/prioricode/releases) ή το [prioricode.ai/download](https://prioricode.ai/download).
...
Μάθετε περισσότερα για τους [πράκτορες](https://prioricode.ai/docs/agents).

### Οδηγός Χρήσης

Για περισσότερες πληροφορίες σχετικά με τη ρύθμιση του PrioriCode, [**πλοηγήσου στον οδηγό χρήσης μας**](https://prioricode.ai/docs).
...
**Γίνε μέλος της κοινότητάς μας** [Discord](https://discord.gg/prioricode) | [X.com](https://x.com/prioricode)
