...
nix run nixpkgs#prioricode           # veya en güncel geliştirme dalı için github:anomalyco/prioricode
```
...
PrioriCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/anomalyco/prioricode/releases) veya [prioricode.ai/download](https://prioricode.ai/download) adresinden indirebilirsiniz.
