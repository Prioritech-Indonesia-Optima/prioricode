...
A Visual Studio Code extension that integrates [prioricode](https://prioricode.ai) directly into your development workflow.

## Prerequisites

This extension requires the [prioricode CLI](https://prioricode.ai) to be installed on your system. Visit [prioricode.ai](https://prioricode.ai) for installation instructions.
